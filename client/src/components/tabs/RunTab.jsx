...
// //             // Send code to ML agent endpoint
// //             const response = await axiosInstance.post("/analyze", {
// //                 question: "Analyze this code and compare with AI models",
// //                 user_code: currentFile.content
// //             })
...
//                 first100Chars: currentFile.content.substring(0, 100)
//             })
...
//                 console.error("🔌 Connection refused - Is the ML server running?")
//                 toast.error("ML analysis server is not running. Please start the server on port 5000.")
//             } else if (error.code === 'ECONNABORTED') {
//                 console.error("⏰ Request timeout")
//                 toast.error("Analysis timeout. The server is taking too long to respond.")
//             } else if (error.response) {
//                 // Server responded with error status
//                 console.error("🚨 Server error:", error.response.status, error.response.data)
//                 toast.error(`Analysis failed: ${error.response.status} - ${error.response.data.error || 'Unknown error'}`)
//             } else if (error.request) {
//                 // Request was made but no response received
//                 console.error("📡 No response received:", error.request)
//                 toast.error("No response from analysis server. Check if the server is running.")
//             } else {
